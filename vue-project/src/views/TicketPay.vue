...
<template>
  <div style="padding-left: 30%">
      <h1 style="text-align: left !important">Payment Information client</h1>
    ...
    <div class="form-container">
      <div class="field-container">
        ...
        <input id="name" v-model="name" maxlength="20" type="text" />
      </div>
      <div class="field-container">
    ...
    <div class="bt-d">
      <el-button v-on:click="to()" type="primary">continue payment</el-button>
    </div>
  </div>
</template>
